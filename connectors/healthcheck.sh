#!/usr/bin/env bash
# This healthcheck script is copied from
# https://github.com/confluentinc/kafka-images/blob/6369da3b5fe18159571ccb2796ca8ed076935b8d/kafka-connect-base/include/etc/confluent/docker/healthcheck.sh
